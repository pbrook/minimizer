...
#include "AT45DB161D.h"
	...
	/* Private Interface - For use in library only: */
		...
		/* Macros: */
			...
			#define DATAFLASH_CHIPCS_DDR  DDRD
			#define DATAFLASH_CHIPCS_PORT PORTD

			#define DATAFLASH_MOSI	(1 << 2)
			#define DATAFLASH_MISO	(1 << 0)
			#define DATAFLASH_SCK	(1 << 1)
			#define DATAFLASH_DDR	DDRD
			#define DATAFLASH_PORT	PORTD
			#define DATAFLASH_PIN	PIND
	#endif
	...
	/* Public Interface - May be used in end-application: */
		...
		/* Inline Functions: */
			...
			static inline void Dataflash_Init(void)
			{
				...
				DATAFLASH_DDR |= DATAFLASH_MOSI | DATAFLASH_SCK;
				DATAFLASH_DDR &= ~DATAFLASH_MISO;
				DATAFLASH_PORT |= DATAFLASH_SCK;
				DATAFLASH_PORT &= ~DATAFLASH_MISO;
			}
			...
			static inline uint8_t Dataflash_TransferByte(const uint8_t Byte)
			{
				...
				for (i = 0; i < 8; i++) {
				      PORTD &= ~DATAFLASH_SCK;
				      if (data & 0x80)
					  PORTD |= DATAFLASH_MOSI;
				      else
					  PORTD &= ~DATAFLASH_MOSI;
				      data <<= 1;
				      PORTD |= DATAFLASH_SCK;
				      if (PIND & DATAFLASH_MISO)
					  data |= 1;
				}
				return data;
			}
			...
			{
				return Dataflash_TransferByte(0xff);
			}
